...
finalcopynumber_filtered  <- copynumber_filtered [,-1]
rownames(finalcopynumber_filtered) <- copynumber_filtered[,1]
...
Data1 = standardNormalization(finalcopynumber_filtered);
Data2 = standardNormalization(finaldnameth_filtered);
Data3 = standardNormalization(finalmrna_filtered);
